                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-3">
                                            <div class="plan">
                                                ...
                                                <ul>
                                                    ...
                                                    <li>Uploaded by <b><?php echo $key->uploader;?></b><br>
                                                        ...
                                                        <a title="Rename" class="signup bg-yellow" href="<?php echo base_url();?>files/edit/<?php echo $key->id;?>"><i class="fa fa-edit"></i></a>
                                                        <a title="Delete" class="signup bg-danger" href="<?php echo base_url();?>files/del/<?php echo $key->id;?>"><i class="fa fa-times"></i></a>
